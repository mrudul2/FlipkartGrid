...
import RecommendedSlider from "../../components/Mobile/Recommended";
          ...
          <div className="flex flex-row space-x-4 justify-evenly">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-center">
                <Link to="/favorites">
                  <button
                    className="my-16 max-h-10 text-white bg-gray-100 hover:bg-gray-200  font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2"
